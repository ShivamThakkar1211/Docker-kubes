...
document.getElementById("last-name").addEventListener("input", LastName);
document.getElementById("last-name").addEventListener("blur", LastName);

document.getElementById("form").onsubmit = function (e) {
    e.preventDefault();
    const isValid = validateFirstName() & validatePassword() & validateEmail() & validateMobileNumber() & validateAddress() & LastName();
    if (isValid) {
